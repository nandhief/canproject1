	...
	<div class="row">
		<div class="col-xs-12">
			<div class="box">
				...
				<div class="box-body">
					{{ Form::model($valas, ['route' => ['valas.update', $valas->id], 'method' => 'PUT', 'files' => true]) }}
					<div class="row">
						...
						<div class="form-group col-md-12 col-sm-12 {{ $errors->has('status') ? 'has-error' : '' }}">
							...
							<div class="radio">
								<label><input type="radio" name="status" value="0" {{ $valas->status ? '' : 'checked' }}> Draf</label>
							</div>
							<div class="radio">
								<label><input type="radio" name="status" value="1" {{ $valas->status ? 'checked' : '' }}>Terbit</label>
							</div>
					...
					<div class="row">
						<div class="form-group col-md-12 col-sm-12">
							<a href="{{ route('valas.show', $valas->id) }}" class="btn btn-flat btn-success"><i class="fa fa-reply"></i> Kembali</a>
