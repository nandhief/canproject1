	...
	<div class="row">
		<div class="col-xs-12">
			<div class="box">
				...
				<div class="box-body">
					{{ Form::model($layanan, ['route' => ['layanan.update', $layanan->id], 'method' => 'PUT', 'files' => true]) }}
					<div class="row">
						...
						<div class="form-group col-md-12 col-sm-12 {{ $errors->has('status') ? 'has-error' : '' }}">
							...
							<div class="radio">
								<label><input type="radio" name="status" value="0" {{ $layanan->status ? '' : 'checked' }}> Draf</label>
							</div>
							<div class="radio">
								<label><input type="radio" name="status" value="1" {{ $layanan->status ? 'checked' : '' }}>Terbit</label>
							</div>
					...
					<div class="row">
						<div class="form-group col-md-12 col-sm-12">
							<a href="{{ route('layanan.show', $layanan->id) }}" class="btn btn-flat btn-success"><i class="fa fa-reply"></i> Kembali</a>
