				...
				<div class="box-body">
					...
					<div class="row">
						...
						<div class="form-group col-md-12 col-sm-12 {{ $errors->has('status') ? 'has-error' : '' }}">
							...
							<div class="radio">
								<label><input type="radio" name="status" value="0" {{ $commodity->status ? '' : 'checked' }}> Draf</label>
							</div>
							<div class="radio">
								<label><input type="radio" name="status" value="1" {{ $commodity->status ? 'checked' : '' }}>Terbit</label>
							</div>
					...
					<div class="row">
						<div class="form-group col-md-12 col-sm-12">
							<a href="{{ route('commodities.show', $commodity->id) }}" class="btn btn-flat btn-success"><i class="fa fa-reply"></i> Kembali</a>
